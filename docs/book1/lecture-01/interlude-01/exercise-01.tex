...
\begin{itemize}
  ...
  \(\ln(\alpha)\)\footnote{\(\ln\) is the natural logarithm (base \(e\)).}
  needs a positive argument.
  ...
  sine/cosine terms.\footnote{\(\sin\) and \(\cos\) are trigonometric functions.
  Their outputs stay between \(-1\) and \(1\).}
\end{itemize}
